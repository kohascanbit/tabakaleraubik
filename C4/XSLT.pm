...
sub XSLTParse4Display {
    ...
    if ( $xslfilename =~ /^\s*"?default"?\s*$/i ) {
        my $htdocs;
        my $theme;
        $lang = C4::Templates::_current_language();
        my $xslfile;
        ...
        elsif ($xslsyspref eq "OPACXSLTDetailsDisplayFilmoteca") {
            $htdocs  = C4::Context->config('opachtdocs');
            $theme   = C4::Context->preference("opacthemes");
            $xslfile = C4::Context->preference('marcflavour') .
                       "slim2OPACDetailFilmoteca.xsl";
        }
          elsif ($xslsyspref eq "OPACXSLTResultsDisplayFilmoteca") {
            $htdocs  = C4::Context->config('opachtdocs');
            $theme   = C4::Context->preference("opacthemes");
            $xslfile = C4::Context->preference('marcflavour') .
                       "slim2OPACResultsFilmoteca.xsl";
        }
