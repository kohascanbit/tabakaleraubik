...
my $url = "";
my $templa = "aqua-detail-es.tmpl";

if ($language eq 'es') {$url="aqua-detail-es.pl";
$templa = "aqua-detail-es.tmpl";
setlanguagecookie( $query, "es-ES"  , $url."?biblionumber=".$biblionumber);
}

if ($language eq 'bq') {$url="aqua-detail-eu.pl";
$templa = "aqua-detail-eu.tmpl";
setlanguagecookie( $query, "eu-ES"  , $url."?biblionumber=".$biblionumber);
}

if ($language eq 'en') {$url="aqua-detail-en.pl";
$templa = "aqua-detail-en.tmpl";
setlanguagecookie( $query, "en"  , $url."?biblionumber=".$biblionumber);
}
