...
#
# $Header: /usr/local/cvs/Tabakalera/opac/cgi-bin/opac/opac-addbybiblionumber-filmoteca.pl,v 1.1 2014/09/02 15:27:56 leire Exp $
#
...
our ( $template, $loggedinuser, $cookie ) = get_template_and_user(
    {
        template_name   => "opac-addbybiblionumber-filmoteca.tmpl",
        query           => $query,
        type            => "opac",
        authnotrequired => 0,
    }
