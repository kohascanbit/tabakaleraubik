...
(function()
{
    ...
    xmlControlField.prototype =
    {
        ...
        {
            var pos = this.themelang.indexOf("prog/");
            var home = this.themelang.substring(0, pos) + "fields/";
            var lang = this.themelang.substring(pos+5, this.themelang.lengh);
            this.xmlDoc = $.ajax({
                type: "GET",
                url: home + lang + "/marc21_field_" + this.tagfield + ".xml",
                dataType: "xml",
                async: false
            }).responseXML;
