...
<!-- $Id: MARC21slim2OPACDetail.xsl,v 1.6 2015/08/17 07:35:17 leire Exp $ -->
<xsl:stylesheet version="1.0"
 ...
 <xsl:variable name="UseAuthoritiesForTracings2" select="marc:sysprefs/marc:syspref[@name='UseAuthoritiesForTracings']"/>
        ...
        <xsl:variable name="lang" select="marc:lang"/>
        
        <xsl:variable name="indLang">
			<xsl:choose>
			<xsl:when test="$lang = 'en'">3</xsl:when>
			<xsl:when test="$lang = 'es-ES'">2</xsl:when>
        ...
        <xsl:if test="$display880">
            <h5 class="author">
                <xsl:call-template name="m880Select">
 <xsl:with-param name="basetags">100,110,111, 910,911</xsl:with-param>
        ...
        <!-- Author Statement -->
        <xsl:call-template name="showAuthor"><xsl:with-param name="authorfield" select="marc:datafield[@tag=100 or @tag=110 or @tag=111 or @tag=910 or @tag=911]"/><xsl:with-param name="UseAuthoritiesForTracings" select="$UseAuthoritiesForTracings"/><xsl:with-param name="indLang" select="$indLang"/></xsl:call-template>

		<xsl:call-template name="showOtherAuthor"><xsl:with-param name="authorfield" select="marc:datafield[@tag=700 or @tag=710 or @tag=711 or @tag=920 or @tag=921]"/><xsl:with-param name="UseAuthoritiesForTracings2" select="$UseAuthoritiesForTracings2"/><xsl:with-param name="indLang" select="$indLang"/></xsl:call-template>
		
    <!-- Language -->
    <xsl:choose>
        <xsl:when test="substring($controlField008,36,3)='spa'">
        	<span class="results_summary type"><span class="label">Language : </span>Spanish</span>
        </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='baq'">
         	<span class="results_summary type"><span class="label">Language : </span>Euskera</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='eng'">
         	<span class="results_summary type"><span class="label">Language : </span>English</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='fre'">
         	<span class="results_summary type"><span class="label">Language : </span>French</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='por'">
         	<span class="results_summary type"><span class="label">Language : </span>Portuguese</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='ger'">
         	<span class="results_summary type"><span class="label">Language : </span>German</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='mul'">
         	<span class="results_summary type"><span class="label">Language : </span>Multiple languages</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='cat'">
         	<span class="results_summary type"><span class="label">Language : </span>Catalan</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='dut'">
         	<span class="results_summary type"><span class="label">Language : </span>Dutch</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='heb'">
         	<span class="results_summary type"><span class="label">Language : </span>Hebrew</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='hun'">
         	<span class="results_summary type"><span class="label">Language : </span>Hungarian</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='ita'">
         	<span class="results_summary type"><span class="label">Language : </span>Italian</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='rus'">
         	<span class="results_summary type"><span class="label">Language : </span>Russian</span>
         </xsl:when>
         <xsl:when test="substring($controlField008,36,3)='jpn'">
         	<span class="results_summary type"><span class="label">Language : </span>Japanese</span>
         </xsl:when>
    </xsl:choose>
 ...
 <xsl:choose><xsl:when test="position()=last()"><xsl:text></xsl:text></xsl:when><xsl:otherwise><xsl:text> ; </xsl:text></xsl:otherwise></xsl:choose>
       ...
       <xsl:if test="marc:datafield[@tag=020]">
        <span class="results_summary isbn">ISBN : 
        ...
        <span class="results_summary issn">ISSN : 
        ...
        <xsl:if test="marc:datafield[substring(@tag, 1, 1) = '6']">
            ...
            <xsl:if test="@ind2=$indLang or @ind2=' ' or (@tag!=600 and @tag!=610 and @tag!=650 and @tag!=651 and @tag!=655)">
	            <a>
	            <xsl:choose>
        ...
        <xsl:for-each select="marc:datafield[@tag=856]">
                                   ...
                                   <a target="_blank"><xsl:attribute name="href"><xsl:value-of select="marc:subfield[@code='u']"/></xsl:attribute>
                                    ...
                                    <xsl:if test="marc:subfield[@code='x']">
                                        <xsl:if test="(marc:subfield[@code='x'] = 'Gordetako eskubideak - Copyright') or marc:subfield[@code='x'] = 'Tabakalera'">
                                        	<xsl:text> (Restricted access, contact UBIK to see the content)</xsl:text>
                                        </xsl:if>
                                    </xsl:if>
                                    <xsl:choose>
        ...
        <xsl:when test="@ind2=8">
			...
			<xsl:value-of select="marc:subfield[@code='a']"/><xsl:text> </xsl:text>
                 ...
                 <xsl:when test="$UseControlNumber = '0'">
                 	<xsl:if test="marc:subfield[@code='a']">
			 <a>
	                      	<xsl:attribute name="href">/cgi-bin/koha/opac-search.pl?idx=au,phr&amp;q=<xsl:value-of select="marc:subfield[@code='a']"/></xsl:attribute>
	                      	<xsl:value-of select="marc:subfield[@code='a']"/>
	                      </a>
	                     <xsl:text>. </xsl:text>
		 </xsl:if>
                      <a><xsl:attribute name="href">/cgi-bin/koha/opac-search.pl?idx=ti,phr&amp;q=<xsl:value-of select="marc:subfield[@code='t']"/></xsl:attribute>
                     <xsl:value-of select="marc:subfield[@code='t']"/>
                     </a>
                     <xsl:if test="marc:subfield[@code='d']">
                        <span class="label"><xsl:text> - </xsl:text><xsl:value-of select="marc:subfield[@code='d']"/></span>
        ...
        <xsl:variable name="count774">
           <xsl:value-of select="count(marc:datafield[@tag=774])" />
        </xsl:variable>
        <xsl:for-each select="marc:datafield[@tag=774]">
        <xsl:if test="@ind1=0">
        
        <xsl:choose>
        	 <xsl:when test="position() &lt; 9 or $count774 &lt; 10">
        	 		<span class="results_summary in"><span class="label">
        	 			<xsl:choose>
			        <xsl:when test="@ind2=' '">
			            Analytics : 
        	 ...
        	 <xsl:otherwise>
        	 	<xsl:if test="position() = 9">
        	 		<a class="seeAnalytics"><xsl:attribute name="href">#</xsl:attribute>Show all</a>
        	 	</xsl:if>
        	 		<span class="results_summary_hidden in"><span class="label">
        	 			<xsl:choose>
			        <xsl:when test="@ind2=' '">
			            Analytics : 
			        </xsl:when>
...
<!-- Other Title Statement: Alternate Graphic Representation (MARC 880) -->
 ...
 <xsl:if test="marc:subfield[@code='a']">
 <a href="/cgi-bin/koha/opac-search.pl?idx=ti&amp;q=:{marc:subfield[@code='a']}">
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">a</xsl:with-param>
 </xsl:call-template>
 </a>
 ...
 <xsl:choose><xsl:when test="position()=last()"><xsl:text></xsl:text></xsl:when><xsl:otherwise><xsl:text> ; </xsl:text></xsl:otherwise></xsl:choose>
    ...
    <xsl:param name="indLang"/>
    
	<xsl:if test="count($authorfield)&gt;0">
	
        <h5 class="author">
        <xsl:for-each select="$authorfield">
		<xsl:if test="@ind2=$indLang or @ind2=' '">
        <xsl:choose>
          <xsl:when test="position()&gt;1"/>
          <xsl:when test="@tag&lt;700"></xsl:when>
	...
	<xsl:choose>
          ...
          <xsl:when test="@tag=110 or @tag=710 or @tag=910"><xsl:call-template name="nameABCDN"/></xsl:when>
          <xsl:when test="@tag=111 or @tag=711 or @tag=911"><xsl:call-template name="nameACDEQ"/></xsl:when>
	</xsl:choose>
