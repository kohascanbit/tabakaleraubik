...
<!-- $Id: MARC21slim2OPACDetailFilmoteca.xsl,v 1.1 2014/09/02 15:27:59 leire Exp $ -->
<xsl:stylesheet version="1.0"
  xmlns:marc="http://www.loc.gov/MARC21/slim"
  xmlns:items="http://www.koha-community.org/items"
  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  exclude-result-prefixes="marc items">
    <xsl:import href="MARC21slimUtilsFilmoteca.xsl"/>
  ...
  <!--       <xsl:if test="$leader7='s' or $leader7='m' ">
        <span class="results_summary analytics"><span class="label">Analytics: </span>
            ...
            <xsl:when test="$UseControlNumber = '1' and marc:controlfield[@tag=001]">
                <xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?q=rcn:<xsl:value-of select="marc:controlfield[@tag=001]"/>+and+(bib-level:a+or+bib-level:b)</xsl:attribute>
            </xsl:when>
            <xsl:otherwise>
                <xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?q=Host-item:<xsl:value-of select="translate(marc:datafield[@tag=245]/marc:subfield[@code='a'], '/', '')"/></xsl:attribute>
            </xsl:otherwise>
            </xsl:choose>
 ...
 -->
        ...
        <span class="results_summary volumes"><span class="label">Volumes : </span>
            ...
            <xsl:choose>
            <xsl:when test="$UseControlNumber = '1' and marc:controlfield[@tag=001]">
                <xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?q=rcn:<xsl:value-of select="marc:controlfield[@tag=001]"/>+not+(bib-level:a+or+bib-level:b)</xsl:attribute>
            </xsl:when>
            <xsl:otherwise>
       ...
       <!--Series: Alternate Graphic Representation (MARC 880) -->
        ...
        <xsl:for-each select="marc:datafield[@tag=440]">
            <a><xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?q=se,phr:"<xsl:value-of select="marc:subfield[@code='a']"/>"</xsl:attribute>
            <xsl:call-template name="chopPunctuation">
                            <xsl:with-param name="chopString">
                                <xsl:call-template name="subfieldSelect">
                                    <xsl:with-param name="codes">av</xsl:with-param>
 ...
 <a href="/cgi-bin/koha/opac-search-filmoteca.pl?q=rcn:{marc:subfield[@code='w']}">
 <xsl:call-template name="chopPunctuation">
 <xsl:with-param name="chopString">
 <xsl:call-template name="subfieldSelect">
       ...
       <xsl:if test="marc:datafield[@tag=020]">
        ...
        <xsl:if test="marc:datafield[substring(@tag, 1, 1) = '6']">
            ...
            <xsl:when test="marc:subfield[@code=9] and $UseAuthoritiesForTracings='1'">
                <xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?q=an:<xsl:value-of select="marc:subfield[@code=9]"/></xsl:attribute>
            </xsl:when>
            <xsl:when test="$TraceSubjectSubdivisions='1'">
                <xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?q=<xsl:call-template name="subfieldSelect">
            ...
            <xsl:otherwise>
               <xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?q=su<xsl:value-of select="$SubjectModifier"/>:<xsl:value-of select="$TracingQuotesLeft"/><xsl:value-of select="marc:subfield[@code='a']"/><xsl:value-of select="$TracingQuotesRight"/></xsl:attribute>
            </xsl:otherwise>
            </xsl:choose>
            <xsl:call-template name="chopPunctuation">
                <xsl:with-param name="chopString">
        ...
        <xsl:when test="@ind2=8">
			...
			<xsl:value-of select="marc:subfield[@code='a']"/><xsl:text> </xsl:text>
                    ...
                    <a><xsl:attribute name="href">/cgi-bin/koha/opac-detail-filmoteca.pl?biblionumber=<xsl:call-template name="extractControlNumber"><xsl:with-param name="subfieldW" select="marc:subfield[@code='w']"/></xsl:call-template></xsl:attribute>
                 ...
                 <xsl:when test="$UseControlNumber = '0'">
                 	<xsl:if test="marc:subfield[@code='a']">
			 <a>
	                      	<xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?idx=au,phr&amp;q=<xsl:value-of select="marc:subfield[@code='a']"/></xsl:attribute>
	                      	<xsl:value-of select="marc:subfield[@code='a']"/>
	                      </a>
	                     <xsl:text>. </xsl:text>
		 </xsl:if>
                      <a><xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?idx=ti,phr&amp;q=<xsl:value-of select="marc:subfield[@code='t']"/></xsl:attribute>
                     <xsl:value-of select="marc:subfield[@code='t']"/>
                     </a>
                     <xsl:if test="marc:subfield[@code='d']">
                        <span class="label"><xsl:text> - </xsl:text><xsl:value-of select="marc:subfield[@code='d']"/></span>
			...
			<a>
                     ...
                     <a><xsl:if test="marc:subfield[@code='t']"><xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?idx=ti,phr&amp;q=<xsl:value-of select="marc:subfield[@code='t']"/></xsl:attribute><xsl:value-of select="marc:subfield[@code='t']"/></xsl:if></a>
                     <xsl:if test="marc:subfield[@code='d']">
                        <span class="label"><xsl:text> - </xsl:text><xsl:value-of select="marc:subfield[@code='d']"/></span>
                     </xsl:if>
                     <xsl:if test="marc:subfield[@code='g']"><xsl:text> - </xsl:text><xsl:value-of select="marc:subfield[@code='g']"/></xsl:if>
                ...
                <xsl:when test="marc:subfield[@code='0']">
                    <a><xsl:attribute name="href">/cgi-bin/koha/opac-detail-filmoteca.pl?biblionumber=<xsl:value-of select="marc:subfield[@code='0']"/></xsl:attribute>
        ...
        <xsl:for-each select="marc:datafield[@tag=775]">
            ...
            <xsl:choose>
            <xsl:when test="$UseControlNumber = '1' and marc:subfield[@code='w']">
                <xsl:attribute name="href">/cgi-bin/koha/opac-detail-filmoteca.pl?biblionumber=<xsl:call-template name="extractControlNumber"><xsl:with-param name="subfieldW" select="marc:subfield[@code='w']"/></xsl:call-template></xsl:attribute>
            </xsl:when>
            <xsl:otherwise>
                <xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?q=ti,phr:<xsl:value-of select="translate($f775, '()', '')"/></xsl:attribute>
            </xsl:otherwise>
            </xsl:choose>
            <xsl:call-template name="subfieldSelect">
                <xsl:with-param name="codes">a_t</xsl:with-param>
 ...
 <xsl:call-template name="showOtherAuthor"><xsl:with-param name="authorfield" select="marc:datafield[@tag=700 or @tag=710 or @tag=711]"/><xsl:with-param name="UseAuthoritiesForTracings2" select="$UseAuthoritiesForTracings2"/></xsl:call-template>
...
<!-- Other Title Statement: Alternate Graphic Representation (MARC 880) -->
 ...
 <xsl:if test="marc:subfield[@code='a']">
 <a href="/cgi-bin/koha/opac-search-filmoteca.pl?idx=ti&amp;q=:{marc:subfield[@code='a']}">
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">a</xsl:with-param>
 </xsl:call-template>
 </a>
 ...
 <xsl:choose><xsl:when test="position()=last()"><xsl:text></xsl:text></xsl:when><xsl:otherwise><xsl:text> ; </xsl:text></xsl:otherwise></xsl:choose>
	...
	<xsl:if test="count($authorfield)&gt;0">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
            <xsl:attribute name="href">/cgi-bin/koha/opac-search-filmoteca.pl?q=au:"<xsl:value-of select="marc:subfield[@code='a']"/>"</xsl:attribute>
            </xsl:otherwise>
        </xsl:choose>
	<xsl:choose>
