...
<!-- $Id: MARC21slim2OPACResultsFilmoteca.xsl,v 1.1 2014/09/02 15:27:59 leire Exp $ -->
...
-->
        ...
        <a><xsl:attribute name="href">/cgi-bin/koha/opac-detail-filmoteca.pl?biblionumber=<xsl:value-of select="$biblionumber"/></xsl:attribute><xsl:attribute name="class">title</xsl:attribute>
