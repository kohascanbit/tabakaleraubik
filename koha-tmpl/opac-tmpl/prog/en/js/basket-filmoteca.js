...
function openBasket() {
    ...
    if ( strCookie ) {
        ...
        var loc = CGIBIN + "opac-basket-filmoteca.pl?" + strCookie;
...
function delSelRecords() {
    ...
    if (recordsSel) {
        ...
        document.location = CGIBIN + "opac-basket-filmoteca.pl?" + strCookie;
    }
    else {
...
function sendBasket() {
    ...
    var loc = CGIBIN + "opac-sendbasket-filmoteca.pl?" + strCookie;
...
function downloadBasket() {
    ...
    var loc = CGIBIN + "opac-downloadcart-filmoteca.pl?" + strCookie;
...
function showMore() {
    ...
    var loc = CGIBIN + "opac-basket-filmoteca.pl?" + strCookie + "&verbose=1";
    document.location = loc;
}
...
function showLess() {
    ...
    var loc = CGIBIN + "opac-basket-filmoteca.pl?" + strCookie + "&verbose=0";
    document.location = loc;
}
...
function addSelToShelf() {
    var items = document.getElementById('records').value;
	if(items){
    document.location = "/cgi-bin/koha/opac-addbybiblionumber-filmoteca.pl?biblionumber="+items;
	} else {
        alert(MSG_NO_RECORD_SELECTED);
    }
}
